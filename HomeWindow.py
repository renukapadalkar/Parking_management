...
from PyQt5.QtWidgets import QWidget, QMainWindow, QPushButton, QLineEdit, QLabel, QVBoxLayout, QHBoxLayout, QFrame, \
    QGridLayout, QComboBox, QTableWidget, QTableWidgetItem, QSizePolicy, QMessageBox, QFileDialog, QApplication
...
class HomeScreen(QMainWindow):
    def __init__(self):
        ...
        #self.setGeometry(500,100,700,1000)


        widget=QWidget()
        widget.setStyleSheet("background:#000 ")
        layout_horizontal=QHBoxLayout() #dividing home screen into menu and pages
        menu_vertical_layout = QVBoxLayout()  #vertical layut for menu
        ...
        menu_frame=QFrame()
        menu_frame.setMaximumWidth(1800)
        ...
        #parent_stacked_layout = QVBoxLayout()
        #parent_stacked_layout.setContentsMargins(0, 0, 0, 0)
        #menu_frame.setMinimumWidth(self.width())
        #menu_frame.setMaximumHeight(self.height())


        #creating 4 layout pages for 4 pages
        ...
        #creating frames for 4 pages
        self.frame_1=QFrame()
        self.frame_1.setMinimumWidth(1400)
        self.frame_1.setMaximumWidth(self.width())
        self.frame_1.setMaximumHeight(self.width())
        self.frame_1.setMaximumHeight(self.width())

        self.frame_1.setLayout(self.vertical_1) #setting vertical layout to 4 frames
        self.frame_2 = QFrame()
        #self.frame_2.setMinimumWidth(1000)
        #self.frame_2.setMaximumWidth(2000)
        #self.frame_2.setMaximumHeight(self.width())
        #self.frame_2.setMaximumHeight(self.width())
        self.frame_2.setLayout(self.vertical_2)
        self.frame_3 = QFrame()
        #self.frame_3.setMinimumWidth(1200)
        #self.frame_3.setMaximumWidth(self.width())
        #self.frame_3.setMaximumHeight(self.width())
        #self.frame_3.setMaximumHeight(self.width())
        ...
        layout_horizontal.addWidget(menu_frame)   #adding layout of menu into parent horizontal layout
        layout_horizontal.addLayout(parent_vertical)#setting horizontal layout in parent verticala layout
        ...
        widget.setLayout(layout_horizontal)    #setting parent horizontal layout object into Qwidget object
    ...
    def showHistory(self):
        ...
        self.btn_add.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FFEA20;color:#fff;font-weight:bold ; border:1px solid white")
        self.btn_manage.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FFEA20;color:#fff;font-weight:bold ; border:1px solid white")
        self.btn_history.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FF7300;color:#fff;font-weight:bold ; border:1px solid white")
    ...
    def showAdd(self):
        ...
        self.btn_home.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FFEA20;color:#fff;font-weight:bold; border:1px solid white")
        self.btn_add.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FF7300;color:#fff;font-weight:bold ; border:1px solid white")
        self.btn_manage.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FFEA20;color:#fff;font-weight:bold ; border:1px solid white")
        self.btn_history.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FFEA20;color:#fff;font-weight:bold ; border:1px solid white")
    ...
    def showManage(self):
        ...
        self.btn_home.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FFEA20;color:#fff;font-weight:bold; border:1px solid white")
        self.btn_add.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FFEA20;color:#fff;font-weight:bold ; border:1px solid white")
        self.btn_manage.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FF7300;color:#fff;font-weight:bold ; border:1px solid white")
        self.btn_history.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FFEA20;color:#fff;font-weight:bold ; border:1px solid white")
    ...
    def showHome(self):
        ...
        self.btn_home.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FF7300;color:#fff;font-weight:bold; border:1px solid white")
        self.btn_add.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FFEA20;color:#fff;font-weight:bold ; border:1px solid white")
        self.btn_manage.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FFEA20;color:#fff;font-weight:bold ; border:1px solid white")
        self.btn_history.setStyleSheet("width:500px;height:250px;font-size:40px;background:#FFEA20;color:#fff;font-weight:bold ; border:1px solid white")
    ...
    def refreshHome(self):
        ...
        for data in alldata:
            ...
            if data[3] == 1:
                label.setStyleSheet("background-color: #5FD068; color:white;padding:5px;width:100px;height:100px;border:1px solid black;text-align:center;font-weight:bold")
            else:
                label.setStyleSheet("background-color: #EB5353; color:white;padding:5px;width:100px;height:100px;border:1px solid black;text-align:center ;font-weight:bold")
    ...
    def addHomePageData(self):
        ...
        button.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:green;border:1px solid black")
    ...
    def addHistoryPage(self):
        ...
        self.frame5.setMinimumWidth(1400)
