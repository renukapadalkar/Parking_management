...
class LoginScreen(QWidget):
    def __init__(self):
        ...
        label_password.setStyleSheet("color:#000;padding:8px 0 px;font -size:18px")
        self.error_msg=QLabel()
        self.error_msg.setStyleSheet("color:red;padding:8px 0 px;font -size:18px;text-align:center")
        ...
        btn_login.clicked.connect(self.showHome) #connect login button to a function
    ...
    def showHome(self):
        ...
        if result:
            ...
            self.close()  # closing login screen
